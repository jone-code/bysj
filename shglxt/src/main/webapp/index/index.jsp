	...
	<div id="wrap">
		...
		<div class="center_content">
			...
			<div class="left_content">
				...
				<!-- 精品推荐 -->
				<div class="title">
					<span class="title_icon"><img src="index/images/bullet1.gif" /></span>精品推荐
				</div>
				...
				<s:iterator var="special" value="specialList">
					...
					<div class="feat_prod_box">
						<div class="prod_img">
							<a href="detail.action?bookid=${id}"><img src="../${cover}"
								class="thumb_big" /></a>
						</div>
				...
				<!-- 最新出版 -->
				<div class="title">
					<span class="title_icon"><img src="index/images/bullet2.gif" /></span>最新出版
				</div>
